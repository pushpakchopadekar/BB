    ...
    <div className="login-container">
      ...
      <div className={`login-card ${isAnimating ? 'card-animate' : ''}`}>
        ...
        <div className="footer">
          {activeTab === 'register' ? (
            <p>Already have an account? <button className="switch-btn" onClick={() => handleTabChange('login')}>Login here</button></p>
          ) : (
            <p>Don't have an account? <button className="switch-btn" onClick={() => handleTabChange('register')}>Sign up here</button></p>
          )}
        </div>
      </div>
    </div>
